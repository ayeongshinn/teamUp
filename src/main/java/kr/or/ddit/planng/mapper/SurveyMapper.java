...
public interface SurveyMapper {
	...
	//질문 등록
	public int insertQuestion(SurveyQstVO surveyQstVO);
	
	//보기 등록
	public int insertOption(SurveyOptionVO surveyOptionVO);
	...
	//질문 유형 가져오기
	public SurveyQstVO getSurveyQstByNo(String srvyQstNo);
	
	//설문 제출
	public int submitSurvey(SurveyVO surveyVO);
	
	//응답 제출
	public int insertSurveyAnswer(SurveyAnsVO surveyAnsVO);
