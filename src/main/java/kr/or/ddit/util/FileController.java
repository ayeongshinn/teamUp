...
public class FileController {
	...
	public ResponseEntity<Resource> downloadFile(String fileName, HttpSession session) {
		...
		String macFastPath = "/Users/shinayeong/sts-workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/teamUp/resources/upload";
				
		String savePath = macFastPath + fileName;
	...
	public Map<String, Object> image(MultipartHttpServletRequest request) throws Exception {
		...
		String savePath = macFastPath + "/" + newFileName;
