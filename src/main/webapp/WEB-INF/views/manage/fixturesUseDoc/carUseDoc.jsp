...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/carUseDoc_style.css">
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(empVO) {
            // 사원 정보가 성공적으로 조회되면 직급명과 부서명 출력
             $('#nmDept').text(empVO.deptNm);
             $('#nmJbgd').text(empVO.jbgdNm);
	...
	//신청사유
	$('#prpsUse').on('input', function() {
		$('#docDet').text($(this).val());
	});
    
    //사용기간
    $('#ymdBgng, #ymdEnd').on('input', function(){
        const useBgngYmd = $('#ymdBgng').val();
        const useEndYmd = $('#ymdEnd').val();

        if (useBgngYmd && useEndYmd) {
            // 날짜 형식을 YYYY.MM.DD로 변환
            const formattedBgngYmd = useBgngYmd.replace(/-/g, '.');
            const formattedEndYmd = useEndYmd.replace(/-/g, '.');
            $('#ymdUse').text(formattedBgngYmd + "부터 " + formattedEndYmd + "까지");
        } else {
            $('#ymdUse').text('');
        }
    });
...
<div class="hpa" style="width: 210mm; height: 296.99mm;">
	...
	<div class="hcD" style="left: 20mm; top: 25mm;">
		<div class="hcI">
			...
			<div class="hls ps19"
				...
				<span class="hrt cs10">법인 차량 사용 신청서</span>
			</div>
			<div class="hls ps19"
		...
		<div id="carUseDoc" class="carUseDoc hcD" style="left: 20mm; top: 25mm;">
		  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/carUseDoc_style.css">	
			<div class="hls ps21"
			...
			<div class="hls ps20"
				style="padding-left: 7.06mm; line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 112.41mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps21"
				style="padding-left: 7.06mm; line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 118.05mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps21"
				style="padding-left: 7.06mm; line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 123.70mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps21"
				style="padding-left: 7.06mm; line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 129.34mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps21"
				style="padding-left: 7.06mm; line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 134.99mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps21"
				style="padding-left: 7.06mm; line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 140.63mm; height: 3.53mm; width: 170mm;">
				<span class="hrt cs7">상기와 같이 법인 차량 사용을 신청합니다.</span>
			</div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 146.28mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 151.92mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 157.56mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 163.21mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 168.85mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 174.50mm; height: 3.53mm; width: 170mm;">
				<span class="hrt cs7" id="docDate" >&nbsp;&nbsp;&nbsp;&nbsp;년 &nbsp;&nbsp;월
					&nbsp;&nbsp;일</span>
			</div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 180.14mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 185.79mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 191.43mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 197.08mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 202.72mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 208.36mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps24"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 214.01mm; height: 3.53mm; width: 170mm;">
				<span class="hrt cs7">신 청 인 :
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(인)</span>
			</div>
			<div class="hls ps24"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 221.06mm; height: 3.53mm; width: 170mm;">
				<span class="hrt cs7">대표이사 :
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(인)</span>
			</div>
			<div class="hls ps19"
				style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: 228.12mm; height: 3.53mm; width: 170mm;"></div>
			<div class="hls ps19"
				style="line-height: 3.43mm; white-space: nowrap; left: 0mm; top: 233.73mm; height: 4.23mm; width: 170mm;">
	...
	<div class="carUseDoc">
	<div class="htb"
		style="left: 21mm; top: 103.58mm; width: 170mm; height: 37mm;">
		<svg class="hs" viewBox="-2.50 -2.50 175 42"
			style="left: -2.50mm; top: -2.50mm; width: 175mm; height: 42mm;">
			...
			<path d="M112.03,0 L112.03,16.51"
				style="stroke:#000000;stroke-linecap:butt;stroke-width:0.12;"></path>
			<path d="M168.01,0 L168.01,33.01"
				style="stroke:#000000;stroke-linecap:butt;stroke-width:0.12;"></path>
			...
			<div class="hcD" style="left: 1.80mm; top: 0.50mm;">
				<div class="hcI" style="top: 1.86mm;">
					<div class="hls ps23"
						...
						<span class="hrt cs7" id="nmDept"></span>
						</div>
				</div>
			</div>
		</div>
			...
			<div class="hcD" style="left: 1.80mm; top: 0.50mm;">
				<div class="hcI" style="top: 1.86mm;">
					<div class="hls ps23"
						...
						<span class="hrt cs7" id="nmJbgd"></span>
						</div>
				</div>
			</div>
		</div>
		...
		<div class="hce"
			...
			<div class="hcD" style="left: 1.80mm; top: 0.50mm;">
				<div class="hcI" style="top: 1.86mm;">
					<div class="hls ps23"
						style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: -0.18mm; height: 3.53mm; width: 49.37mm;">
						<span class="hrt cs7" id="empNo" data-empno="${empVO.empNo}">${empVO.empNm}</span>
						</div>
				</div>
			</div>
		</div>
			...
			<div class="hcD" style="left: 1.80mm; top: 0.50mm;">
				<div class="hcI" style="top: 1.86mm;">
					<div class="hls ps23"
						...
						<span class="hrt cs7" id="docDet"></span>
						</div>
				</div>
			</div>
		</div>
		...
		<div class="hce"
			...
			<div class="hcD" style="left: 1.80mm; top: 0.50mm;">
				<div class="hcI" style="top: 1.86mm;">
					<div class="hls ps23"
						style="line-height: 2.79mm; white-space: nowrap; left: 0mm; top: -0.18mm; height: 3.53mm; width: 133.38mm;">
						<span class="hrt cs7" id="ymdUse" ></span>
						</div>
				</div>
			</div>
		</div>
