...
<form id="hrMovementForm" action="/hrMovementDoc/registPost" method="post">
	...
	<div class="grid gap-6 mb-6">
		...
		<div>
			<label for="trgtEmpNo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">대상 사원<code> *</code></label>
			<input type="text" id="trgtEmpNo" name="trgtEmpNo"
	...
	<div class="grid gap-6 mb-6 lg:grid-cols-2">
		...
		<div>
			...
			<select name="jbgdCd" id="jbgdCd" class="form-control">
				<option value="" selected disabled>선택해주세요</option>
