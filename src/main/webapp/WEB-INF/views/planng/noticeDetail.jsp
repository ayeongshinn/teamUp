			...
			<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
				<div class="p-14 bg-white border-b border-gray-200">
					<div class="pb-2 text-sm flex justify-between items-center">
						<a id="category" href="/noticeList" class="text-md">공지사항</a>
						 <div class="inline-flex rounded-md" role="group">
					        <a href="/noticeList" class="px-2.5 py-1 rounded-l-lg border border-gray-200 bg-white text-sm font-medium text-gray-400 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
					            목록
					        </a>
					        <a href="/noticeDetail?ntcNo=${nextNotice.ntcNo}" class="px-3 py-1 border-t border-b border-gray-200 bg-white font-medium text-gray-400 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700"
					        		style="font-size: 0.4rem;">
					            ▲
					        </a>
					        <a href="/noticeDetail?ntcNo=${prevNotice.ntcNo}" class="px-3 py-1 rounded-r-md border border-gray-200 bg-white font-medium text-gray-400 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700"
					        		style="font-size: 0.4rem;">
					           	▼
					        </a>
					    </div>
						...
						<h3 class="title font-semibold flex items-center">
							<c:choose>
								<c:when test="${noticeVO.imprtncYn == 'Y'}">
									<img alt="imprtncY" src="/resources/images/imprtncY.png" class="mr-2" style="width:18px;">
								</c:when>
							</c:choose>
							${noticeVO.ntcTtl}
						</h3>
					...
					<div class="text-sm text-gray-600 mb-1 flex justify-end items-center">
					    ...
					    <span style="margin-left: 4px;">${noticeVO.inqCnt}</span>
					</div>
					<div>
