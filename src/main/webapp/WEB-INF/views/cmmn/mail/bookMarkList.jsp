	...
	<div class="max-w-7xl mx-auto sm:px-8 lg:px-10">
		<div class="w-full flex justify-between items-center mt-1 pl-3">
			<div style="margin-top: 30px; margin-bottom: 10px;">
				...
				<p class="text-slate-500">즐겨찾는메일함</p>
			</div>
					...
					<form id="selectStatus">
						<table class="table table-hover text-nowrap mb-0"
							...
							<thead
								...
								<tbody id="tby" style="display: block; max-height: 750px;width: 100%;">
					...
					<nav aria-label="Page navigation"
						...
						<ul class="inline-flex space-x-2">
							...
							<li><c:if test="${articlePage.startPage gt 5}">
									<a
										href="/cmmn/mail/bookMarkList?currentPage=${articlePage.startPage-5}&empNo=${empVO.empNo}"
										style="color: #4E7DF4"
								...
								<c:if test="${articlePage.currentPage == pNo}">
									<li>
										<button id="button-${pNo}"
											onclick="javascript:location.href='/cmmn/mail/bookMarkList?currentPage=${pNo}&empNo=${empVO.empNo}';"
