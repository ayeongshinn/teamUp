...
$(function () {
	...
	$("#buttonDelete").click(function(){
	    ...
	    location.href = "/cmmn/mail/dmailDelPost?groupList="+ groupList+"&&empNo="+"${empVO.empNo}";
	...
	<div class="max-w-7xl mx-auto sm:px-8 lg:px-10">
		<div class="w-full flex justify-between items-center mt-1 pl-3">
			...
			<div style="margin-top: 30px; margin-bottom: 10px;">
				...
				<p class="text-slate-500">보낸 메일들을 확인하세요</p>
			</div>
							...
							<div class="flex justify-end space-x-3 mt-2 mb-2">
								<div class="inline-flex items-center rounded-md mr-20"
									...
									<button type="button" id="buttonDelete" disabled
										class="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded font-medium px-4 py-2 inline-flex mr-20 space-x-1 items-center">
						      	 ...
						      	 <div  style="display: flex; width: 100px;"class="mt-2 ml-5">
									<div class="mr-2">
		...
		<div class="relative flex flex-col w-full  text-gray-700 bg-white shadow-md rounded-lg bg-clip-border"
				...
				<div class="card-body p-0"
					style="max-height: 800px; width: 100%; overflow: auto;">
					<form id="selectStatus">
						...
						<thead
							...
							<tr>
								<th style="width:10%"><input type="checkbox" id="selection_all"
									class="button_checkbox blind"></th>
								<th style="width:5%"></th>
						...
						<tbody id="tby"
								style=" max-height: 750px; overflow-y: auto; width: 100%;">
							<c:forEach var="mailDVO" items="${mailDVOList}">
								<c:forEach var="mailRVO" items="${mailDVO.mailRVOList}">
									<tr>
										...
										<td style="text-align: left; width: 50%;"><a href="/cmmn/mail/DMailDetail?mailNo=${mailDVO.mailNo}">
					...
					<nav aria-label="Page navigation"
						...
						<ul class="inline-flex space-x-2">
							...
							<li><c:if test="${articlePage.startPage gt 5}">
									<a
										href="/cmmn/mail/sendList?currentPage=${articlePage.startPage-5}&empNo=${empVO.empNo}"
										style="color: #4E7DF4"
								...
								<c:if test="${articlePage.currentPage == pNo}">
									<li>
										<button id="button-${pNo}"
											onclick="javascript:location.href='/cmmn/mail/sendList?currentPage=${pNo}&empNo=${empVO.empNo}';"
